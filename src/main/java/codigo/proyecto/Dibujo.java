    ...
    public void Letras(String estilo, char caracter, char caracterAnt, AnchorPane root, TextFlow textoCoord, ToggleButton puntosDeControl, int borrar, ScrollPane scrollPane, int tamanio) {
        ...
        if (caracter == 'j' || caracter == 'J') {
            ...
            if (caracter == 'j') {
                ...
                while(cont < auxBold) {
                    ...
                    CubicCurve cb3 = new CubicCurve(x, y, x - tamanio, y + 20*tamanio, x + 5*tamanio, y + 60*tamanio, x, y + 70*tamanio); //"l" superior
                    cb3.setFill(Color.TRANSPARENT);
                    cb3.setStroke(color);
                    cb3.setStrokeWidth(grosor);
                    ...
                    Circle cd1 = new Circle(x*tamanio, y - 10*tamanio, tamanio);
        ...
        if (caracter == 'l' || caracter == 'L') {
            if (caracter == 'l') {
                ...
                while(cont < auxBold) {
                    CubicCurve cb1 = new CubicCurve(x*tamanio, y + 15*tamanio, x + 37*tamanio, y - 40*tamanio, x - 3*tamanio, y - 120*tamanio, x - tamanio, y + 40*tamanio); //Curva principal
                    cb1.setFill(Color.TRANSPARENT);
                    cb1.setStroke(color);
                    cb1.setStrokeWidth(grosor);
